    ...
    <form @submit.prevent="registerKupac">
        <div style="width: 50%; background:white; padding: 5%; border-radius:2%;">
            <div class="mb-3" >
                ...
                <input type="checkbox" class="form-control" id="dostavljeno" v-model="formData.dostavljeno">
            </div>
            <div class="mb-3">
                <label for="ime" class="form-label">Ocena:</label>
                <input type="text" class="form-control" id="ime" v-model="formData.ocena">
            </div>
            <div class="mb-3">
                <label for="prezime" class="form-label">Kometar:</label>
                <input type="text" class="form-control" id="prezime" v-model="formData.komentar">
            </div>
            <div class="mb-3">
                <label for="korisnickoIme" class="form-label">anonimiKomentar:</label>
                <input type="checkbox" class="form-control" id="korisnickoIme" v-model="formData.anonimiKomentar">
            </div>
            <div class="mb-3">
                <label for="loz" class="form-label">arhiviraniKomentar:</label>
                <input type="checkbox" class="form-control" id="loz" v-model="formData.arhiviraniKomentar">
            </div>
            <button @click="napraviPorudzbinu()" type="submit" class="btn btn-primary">Add</button>
        </div>
    </form>
</template>
